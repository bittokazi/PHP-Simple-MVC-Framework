            ...
            <div class="card">
              ...
              <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Enter first name" name="fname" value="<?php if(isset($data->data['data'])) echo $data->data['data'][4]; ?>">
                </div>
                
                <div class="form-group">
                    <label class="control-label">Last Name</label>
                    <input class="form-control" type="text" placeholder="Enter last name" name="lname" value="<?php if(isset($data->data['data'])) echo $data->data['data'][5]; ?>">
                </div>
                
                <div class="form-group">
                    <label class="control-label">Email</label>
                    <input class="form-control" type="email" placeholder="Enter email" name="email" value="<?php if(isset($data->data['data'])) echo $data->data['data'][3]; ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="select" name="status">
                        ...
                        <option value="1" <?php if(isset($data->data['data'])) { if($data->data['data'][6]==1) echo 'selected'; } ?>>Enabled</option>
                        
                        <option value="0" <?php if(isset($data->data['data'])) { if($data->data['data'][6]==0) echo 'selected'; } ?>>Disabled</option>
