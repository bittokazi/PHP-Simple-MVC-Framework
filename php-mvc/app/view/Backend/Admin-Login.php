...
.login-btn:hover:after, .login-btn:focus:after, .login-btn:active:after {
  ...
  <script>
    var dash_url="<?php echo Core\URL::to('dashboard') ?>";
    </script>
...
<div class="login">
  ...
  <script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>
    <script>var url="<?php echo Core\URL::to('dashboard/login') ?>";</script>
    <script src="<?php echo Core\URL::asset('assets/js/admin.js'); ?>"></script>
